...
class RoleController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware(['permission:manage-role','web','auth','2fa','role:admin']);
    }
    ...
    {
        $roles = Role::all();
        return view('admin-views.roles.index')->with('roles', $roles);
    }
    ...
    {
        return view('admin-views.roles.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin-views.roles.show')
                    ->with('role', $role)
    ...
    {
        $role = Role::find($id);
        return view('admin-views.roles.edit')->with('role', $role);
    }
