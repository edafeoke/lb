...
class PermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin-views.permission.index')->with('permissions', $permissions);
    }
    ...
    {
        return view('admin-views.permission.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin-views.permission.edit')->with('permission', $this->permission);
    }
