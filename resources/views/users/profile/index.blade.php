              ...
              <div class="row">
                ...
                <div id="avatar-updater" class="col-xs-12 d-none">
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <input type="text" name="avatar-url" class="d-none" value="{{url('account/update-avatar',Auth::user()->id)}}">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content mt-3 mx-0">
                        <div class="tab-pane active" id="account-details" role="tabpanel" aria-labelledby="account-details-tab">
                              <form class="form-horizontal" method="POST" action="{{route('account.profile.update',$user->id)}}">
                                  @csrf
                                  @method('put')
                                  <div class="row form-group">
                                        ...
                                        <div class="col-md-6 mt-1">
                                          ...
                                          <select class="form-control" name="status" disabled>
                                            ...
                                            <option value="hold" {{($user->status == 'hold')? 'SELECTED':''}}>{{'On Hold'}}</option>
                                          </select>
                                        </div>
                        ...
                        <div class="tab-pane" id="login-details" role="tabpanel" aria-labelledby="login-details-tab">
                          <form class="form-horizontal" method="POST" action="{{route('account.update-login',$user->id)}}">
                              @csrf
                                  <div class="row form-group">
                                        <div class="col-md-6">
                        ...
                        <div class="tab-pane" id="tfa-settings" role="tabpanel" aria-labelledby="tfa-settings-tab">
                          ...
                          <div class="col-md-12">
                            ...
                            <!--=============Generate QRCode for Google 2FA Authentication=============-->
                              <!-- <form class="form-horizontal" method="POST" action="">
                                @csrf -->
                                  ...
                                  <div class="col-md-12">
                                    <form class="" action="{{route('account.activate-2fa')}}" method="post">
                                      @csrf
                            ...
                            <!--=============Enable Google 2FA Authentication=============-->
                              <form class="form-horizontal" method="POST" action="{{route('account.enable-2fa')}}">
                                @csrf
                                    <div class="row">
                            ...
                            <!--=============Disable Google 2FA Authentication=============-->
                              <form class="form-horizontal" method="POST" action="{{route('account.disable-2fa')}}">
                                @csrf
                                    <div class="row">
                                          <div class="col-md-12"><img src="{{$generated}}" /></div>
                                          <div class="col-md-12">
