            ...
            <div class="card">
              ...
              <div class="card-body text-center">
                   @if (session('error'))
                    ...
                    @endif
                    <h5 class="text-center">{{ __('Account Pin Verification') }}</h5>
                      <form class="d-inline" method="POST" action="{{ route('account.verify-pin') }}">
                          @csrf
                            <div class="form-group has-feedback">
                                <input id="pin" type="password" placeholder="{{ __('Enter Pin') }}" class="form-control @error('pin') is-invalid @enderror" name="pin" value="" >
                          ...
                          <button type="submit" class="btn btn-primary col-md-12">{{ __('Verify Pin') }}</button>
                      </form>
                </div>
            </div>
