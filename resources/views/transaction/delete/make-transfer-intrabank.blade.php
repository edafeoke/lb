                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group {{($tab == 1)? '' : 'd-none'}} ">
                            <form class="form-horizontal" method="POST" action="{{url('account/process-transfer',[1,'intra-bank'])}}">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-12">
                        ...
                        <div class="form-group {{($tab == 2 || session('tab') == 2)? '' : 'd-none'}}">
                            <form class="form-horizontal" method="POST" action="{{url('account/process-transfer',[2,'intra-bank'])}}">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-12">
                                    <div class="form-group">
                        ...
                        <div class="form-group {{($tab == 3 || session('tab') == 3)? '' : 'd-none'}}">
                            <form class="form-horizontal" method="POST" action="{{url('account/process-transfer',[3,'intra-bank'])}}">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-12">
                                    <div class="form-group">
                        ...
                        <div class="form-group {{($tab == 4 || session('tab') == 4)? '' : 'd-none'}}">
                            <form class="form-horizontal" method="POST" action="{{url('account/process-transfer',[4,'intra-bank'])}}">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-12">
                                    <div class="form-group">
