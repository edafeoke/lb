        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            {{-- <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{url('admin/credit/account')}}">Credit Account</a></li>
            </ol> --}}
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-7 mx-auto">
            ...
            <form class="form-horizontal" method="POST" action="{{url('admin/credit-debit/account','credit')}}">
                  @csrf
                  <!-- Permission Creation -->
                  <div class="card">
                          ...
                          <div class="row">
                            <div class="col-sm-12">
                              ...
                              <div class="form-group">
                                ...
                                <input name="bank" class="form-control" id="bank" value="{{old('bank')}}" placeholder="Bank Name">
                                @error('bank')
                                  <span class="text-danger" role="alert">
                                      <strong>{{ $message }}</strong>
                                  </span>
                              ...
                              <div class="col-sm-8 mx-auto" ><button type="submit" class="btn btn-success text-white btn-outline-secondary col-sm-12">Credit Account</button></div>
                            </div>
                              </div>
                        </div>
                    </div>
