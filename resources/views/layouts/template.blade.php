...
<head>
    ...
    <script src="{{asset('plugins/tradeview/tv.js')}}"></script>
  ...
  <!-- FAVICON -->
    ...
    <style>
      :root{
        ...
        --dashboardBg: {{setting("app_dashboardBg")}};
        --font-color: {{setting("app_font_color")}};
      }
      .navbar {
...
<div class="wrapper">
  ...
  <footer class="main-footer text-center">
    <strong>Copyright &copy; {{date('Y')}} <a href="{{config('app.url')}}">{{setting('app_name')}}</a>.</strong> All rights
    reserved.
  </footer>
</div>
<!-- ./wrapper -->
...
{{-- <script type="text/javascript">window.$crisp=[];window.CRISP_WEBSITE_ID="1200d899-7ebc-486d-b513-57e1187e1e2c";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();</script> --}}
